...
### RezervasyonYap
My first startup, an appointment platform for barber shops in Turkey.
It failed, but taught me product development, deployment, customers, and what shipping a real product actually means.

### SaaS → CLI Agent
My second major project, built to learn AI systems.
A SaaS-connected CLI agent exploring **agents, multi-agent systems, tools, memory, APIs, and workflows**.
...
[![X](https://img.shields.io/badge/X-000000?logo=x&logoColor=white)](https://x.com/Arvin_vx)
[![Discord](https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white)](https://discord.com/users/arvinvx)
[![GitHub](https://img.shields.io/badge/GitHub-181717?logo=github&logoColor=white)](https://github.com/Arvinvx)
